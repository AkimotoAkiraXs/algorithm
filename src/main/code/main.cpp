...
void init() {
    ...
    matrix[AsrStateType::ARRAY_START][AsrCharType::SQ] = AsrStateType::STRING_START;
    matrix[AsrStateType::ARRAY_START][AsrCharType::SP] = AsrStateType::ARRAY_START;
    matrix[AsrStateType::STRING_START][AsrCharType::SQ] = AsrStateType::STRING_END;
    matrix[AsrStateType::STRING_START][AsrCharType::E] = AsrStateType::ESCAPE;
    matrix[AsrStateType::STRING_START][AsrCharType::C] = AsrStateType::STRING_START;
    ...
    matrix[AsrStateType::ARRAY_NEXT][AsrCharType::SQ] = AsrStateType::STRING_START;
...
void prt() {
    for (size_t i = 0; i < stateTypeSize; i++) {
        for (size_t j = 0; j < charTypeSize; j++) {
            if (matrix[i][j] == 1) {
                cout << "YES";
            }
            cout << matrix[i][j] << " ";
